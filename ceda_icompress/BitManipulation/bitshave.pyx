...
from bitmasks import get_sigexp_bitmask, get_man_bitmask

cpdef bitshave(np.ndarray A, int NSB):
    ...
    zero after the NSB bit.  (NSB = number of significant bits)
    ...
    Args:
        ...
        NSB (int)      : number of significant bits.  Set all bits to zero
                         after this bit
